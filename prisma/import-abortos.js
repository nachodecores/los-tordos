...
async function main() {
  const filePath = path.join(__dirname, "abortos.csv");
  if (!fs.existsSync(filePath)) {
    console.error("Crear prisma/abortos.csv con columnas: caravana,fecha");
    process.exit(1);
  }
  ...
  console.log(`\nListo: ${inserted} abortos importados.`);
}
