...
async function main() {
  const filePath = path.join(__dirname, "partos.csv");
  if (!fs.existsSync(filePath)) {
    console.error("Crear prisma/partos.csv con columnas: caravana,fecha");
    process.exit(1);
  }
  ...
  console.log(`\nListo: ${inserted} partos importados.`);
}
